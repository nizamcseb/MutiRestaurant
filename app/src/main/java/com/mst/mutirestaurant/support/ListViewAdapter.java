...
import com.mst.mutirestaurant.Activities.SignupActivity;
	...
	public View getView(final int position, View view, ViewGroup parent) {
		...
		view.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				SignupActivity.reglay.setVisibility(View.VISIBLE);
				SignupActivity.counlay.setVisibility(View.GONE);

				SignupActivity.mCountrycode.setText(cf.ccode);



				SignupActivity.editsearch.setText("");
