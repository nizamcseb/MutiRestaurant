 ...
 */
public class Trackorder_fragment extends Fragment {
    ...
    public static Trackorder_fragment init(int val) {
        Trackorder_fragment truitonFrag = new Trackorder_fragment();
