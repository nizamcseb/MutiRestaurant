...
import com.mst.mutirestaurant.Activities.SearchActivity;
...
public class SearchAdapter  extends BaseAdapter {
    ...
    public SearchAdapter(Context c, ArrayList<HashMap<String, String>> d) {
        activity = c;
        data = d;
            ...
            public void onClick(View v) {
             ...
             /*   int  addd =   Integer.parseInt(Vholder.tv_Quantity.getText().toString());
                ...
                if(c.getCount() == 0) {
                    ...
                    ((SearchActivity)activity).doIncrease();
